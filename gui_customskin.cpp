...
namespace gui
{
	...
	public:
		...
		MySkin(EGUI_SKIN_TYPE type, video::IVideoDriver* driver);
		virtual ~MySkin();
...
MySkin::MySkin(EGUI_SKIN_TYPE type, video::IVideoDriver* driver)
...
video::SColor MySkin::getColor(EGUI_DEFAULT_COLOR color) const
{
...
void MySkin::setColor(EGUI_DEFAULT_COLOR which, video::SColor newColor)
{
...
s32 MySkin::getSize(EGUI_DEFAULT_SIZE size) const
{
...
//! sets a default size
void MySkin::setSize(EGUI_DEFAULT_SIZE which, s32 size)
{
...
IGUIFont* MySkin::getFont(EGUI_DEFAULT_FONT which) const
{
...
//! sets a default font
void MySkin::setFont(IGUIFont* font, EGUI_DEFAULT_FONT which)
{
...
IGUISpriteBank* MySkin::getSpriteBank() const
{
	return SpriteBank;
}
...
void MySkin::setSpriteBank(IGUISpriteBank* bank)
{
	if (bank)
		bank->grab();
...
u32 MySkin::getIcon(EGUI_DEFAULT_ICON icon) const
{
...
//! Sets a default icon
void MySkin::setIcon(EGUI_DEFAULT_ICON icon, u32 index)
{
	if ((u32)icon < EGDI_COUNT)
		Icons[icon] = index;
}
...
const wchar_t* MySkin::getDefaultText(EGUI_DEFAULT_TEXT text) const
{
...
//! "OK", "Cancel", "Yes", "No" and so on.
void MySkin::setDefaultText(EGUI_DEFAULT_TEXT which, const wchar_t* newText)
{
...
core::rect<s32> MySkin::draw3DWindowBackground(IGUIElement* element,
				bool drawTitleBar, video::SColor titleBarColor,
				const core::rect<s32>& r,
				const core::rect<s32>* clip,
				core::rect<s32>* checkClientArea)
...
\param rect: Defining area where to draw.
\param clip: Clip area.	*/
void MySkin::draw3DMenuPane(IGUIElement* element,
...
\param rect: Defining area where to draw.
\param clip: Clip area.	*/
void MySkin::draw3DToolBar(IGUIElement* element,
				const core::rect<s32>& r,
				const core::rect<s32>* clip)
{
	if (!Driver)
...
\param rect: Defining area where to draw.
\param clip: Clip area.	*/
void MySkin::draw3DTabButton(IGUIElement* element, bool active,
...
\param rect: Defining area where to draw.
\param clip: Clip area.	*/
void MySkin::draw3DTabBody(IGUIElement* element, bool border, bool background,
...
\param clip: Clip area.	*/
void MySkin::drawIcon(IGUIElement* element, EGUI_DEFAULT_ICON icon,
			const core::position2di position,
...
EGUI_SKIN_TYPE MySkin::getType() const
{
	return Type;
}
...
void MySkin::draw2DRectangle(IGUIElement* element,
...
void MySkin::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options) const
{
	u32 i;
...
void MySkin::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options)
{
	u32 i;
	for (i=0; i<EGDC_COUNT; ++i)
...
int main()
{
	...
	MySkin * mySkin = new MySkin(EGST_WINDOWS_CLASSIC, driver);
	env->setSkin(mySkin);

	IGUITabControl* tabCtrl = env->addTabControl (core::rect<s32>(1,1, 100, 100));
